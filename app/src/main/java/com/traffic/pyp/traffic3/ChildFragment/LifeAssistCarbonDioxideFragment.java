 ...
 */
public class LifeAssistCarbonDioxideFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_life_assist_carbon_dioxide, container, false);
        initView();
        initData();
        return view;
    }
    ...
    private void initData() {
        ...
        lineChart.setDescription("过去1分钟最大相对浓度：60");
        //设置x轴的数据
