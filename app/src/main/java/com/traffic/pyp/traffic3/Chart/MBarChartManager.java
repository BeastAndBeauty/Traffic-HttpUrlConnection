...
public class MBarChartManager {
    ...
    public static BarData initBarChartManager(Context context, BarChart barChart, String[] count, float[] datas) {
        ...
        dataSet.setBarSpacePercent(120f);
        dataSet.setValueTextSize(50f);     //数值显示的大小
    ...
    public static void initDataStyle(final BarChart barChart, BarData barData, Context context) {
        barChart.setDescriptionPosition(1500f, 25f);
        //字的颜色
        barChart.setDescriptionColor(Color.BLACK);
        //字号
        barChart.setDescriptionTextSize(50f);
